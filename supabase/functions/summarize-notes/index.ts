...
- Use clear, simple language`;
    ...
    for (let attempt = 0; attempt <= maxRetries; attempt++) {
      try {
        ...
        console.error(`[SUMMARIZE] Gateway error (attempt ${attempt + 1}):`, response.status, errorText);
        ...
        console.error(`[SUMMARIZE] Fetch error (attempt ${attempt + 1}):`, fetchError);
    ...
    console.error("[SUMMARIZE] All retries failed:", lastError);
    return new Response(
